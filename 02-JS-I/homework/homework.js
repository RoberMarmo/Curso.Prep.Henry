...
function devolverString(str) { 
  return str;
  //var  "Return" la string provista: str
  // Tu código:
}
...
function obtenerSaludo(nombre) {  var nombre = nombre; 
return "Hola"+" "+ nombre + "!";
...
function esVocal(letra){ if ( letra==='a' || letra==='e' ||letra==='i' ||letra==='o' ||letra==='u' ){ return "Es vocal"; }
